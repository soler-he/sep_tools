...
pytest -ra --mpl --mpl-baseline-path=baseline --mpl-baseline-relative --mpl-generate-summary=html --mpl-results-path='tests_report/' --durations=0 fit_spectra/tests/test_.py
"""
