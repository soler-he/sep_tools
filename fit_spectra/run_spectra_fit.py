...
# from make_the_fit import find_I0
...
def run_the_fit(path, data, save, use_filename_as_title = False, channels_to_exclude = None, 
    ...
    Args:
        ...
        E_0 (float, optional): The energy that corresponds to intensity at I0. Defaults to E_0=0.1 (MeV).
