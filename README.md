[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.15058293.svg)](https://doi.org/10.5281/zenodo.15058293)
...
- [`SEP_Fit-Spectra.ipynb`](https://github.com/soler-he/sep_tools/blob/main/SEP_Fit-Spectra.ipynb)<br>Tool to fit energetic particle energy spectra. Can be used to fit peak spectra or fluence spectra determined with `SEP_Spectra.ipynb` (see below).
...
- [`SEP_Spatial-Distribution.ipynb`](https://github.com/soler-he/sep_tools/blob/main/SEP_Spatial-Distribution.ipynb)<br>Analyzes the SEP distribution by fitting Gaussian curves to the intensity as a function of the observers' longitudes.
...
- [`SEP_Fit-Spectra.ipynb`](https://hub-route-serpentine-soler.2.rahtiapp.fi/hub/user-redirect/lab/workspaces/auto-8/tree/soler/sep_tools/SEP_Fit-Spectra.ipynb)<br>Tool to fit energetic particle energy spectra. Can be used to fit peak spectra or fluence spectra determined with `SEP_Spectra.ipynb` (see below).
...
- [`SEP_Spatial-Distribution.ipynb`](https://hub-route-serpentine-soler.2.rahtiapp.fi/hub/user-redirect/lab/workspaces/auto-8/tree/soler/sep_tools/SEP_Spatial-Distribution.ipynb)<br>Analyzes the SEP distribution by fitting Gaussian curves to the intensity as a function of the observers' longitudes.
