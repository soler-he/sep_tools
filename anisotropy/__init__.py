...
def run_SEPevent(path, spacecraft_instrument, starttime, endtime, species, bg_start=None, bg_end=None, channels=2, specieschannel=None, averaging=None, corr_window_end=None, solo_ept_ion_contamination_correction=False, plot_folder=None, offline=False):
    ...
    event = SEPevent(event_id, path, sc, instrument, species, channels, starttime, endtime, averaging, av_min, solo_ept_ion_contamination_correction, plot_folder=plot_folder, offline=offline)
